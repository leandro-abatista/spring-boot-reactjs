...
import com.leandroab.financas.enums.StatusLancamento;
import com.leandroab.financas.enums.TipoLancamento;
...
@Entity
@Table(name = "lancamento", schema = "lancamento")
public class Lancamento implements Serializable {
	...
	@ManyToOne//muitos lançamento para um usuário
